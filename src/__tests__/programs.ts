...
test('grand master hort', () => {
  ...
  expect(calculateLevel(plantRules, subs(6, 650, 2, 4))).toBe("Grand Master Aquatic Horticulturist");
});

test('senior grand master hort', () => {
  expect(calculateLevel(plantRules, subs(6, 84, 2, 5))).toBe("Senior Grand Master Aquatic Horticulturist");
  expect(calculateLevel(plantRules, subs(6, 129, 2, 7))).toBe("Senior Grand Master Aquatic Horticulturist");
});
...
test('senior premier hort', () => {
  expect(calculateLevel(plantRules, subs(6, 180, 2, 7))).toBe("Senior Premier Aquatic Horticulturist");
  expect(calculateLevel(plantRules, subs(6, 9999, 2, 7))).toBe("Senior Premier Aquatic Horticulturist");
});
...
test('senior grand master prop', () => {
  expect(calculateLevel(coralRules, subs(0, 100, 0, 0))).toBe("Senior Grand Master Coral Propagator");
  expect(calculateLevel(coralRules, subs(0, 0, 0, 9999))).toBe("Senior Grand Master Coral Propagator");
});
