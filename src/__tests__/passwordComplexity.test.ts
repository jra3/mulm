...
void describe("Password Complexity Validation", () => {
  void describe("Level 1 - Length Only (Default)", () => {
    void test("should reject passwords shorter than 12 characters", () => {
      const result = validatePasswordComplexity("short");
      assert.strictEqual(result.valid, false);
      assert.ok(result.errors[0].includes("12 characters"));
    });

    void test("should accept passwords with 12+ characters", () => {
      const result = validatePasswordComplexity("thisislongenough");
      assert.strictEqual(result.valid, true);
      assert.strictEqual(result.errors.length, 0);
    });

    void test("should accept simple long passwords at level 1", () => {
    ...
    void test("should accept passphrases", () => {
      const result = validatePasswordComplexity("correct horse battery staple");
      assert.strictEqual(result.valid, true);
    });
  });

  void describe("Password Requirements Message", () => {
    void test("should return appropriate message for current level", () => {
  ...
  void describe("Edge Cases", () => {
    void test("should handle exactly 12 characters", () => {
      const result = validatePasswordComplexity("exactlytwelv");
      assert.strictEqual(result.valid, true);
    });

    void test("should handle very long passwords", () => {
    ...
    void test("should handle special characters at level 1", () => {
    ...
    void test("should handle spaces", () => {
      const result = validatePasswordComplexity("my secure password");
      assert.strictEqual(result.valid, true);
    });
  });

  void describe("Multiple Error Reporting", () => {
    void test("should report all errors for invalid password", () => {
