...
describe('Species Split Name Schema CRUD', () => {
  ...
  describe('addCommonName', () => {
    ...
    test('should throw error for empty name', async () => {
      await assert.rejects(
        async () => await addCommonName(testGroupId, ''),
    ...
    test('should throw error for non-existent group', async () => {
      await assert.rejects(
        async () => await addCommonName(99999, 'Test'),
        { message: /not found/ }
      );
    });
    ...
    test('should throw error for duplicate common name in same group', async () => {
      await assert.rejects(
        async () => await addCommonName(testGroupId, 'Test Fish'),
  ...
  describe('addScientificName', () => {
    ...
    test('should throw error for empty name', async () => {
      await assert.rejects(
        async () => await addScientificName(testGroupId, ''),
        { message: /cannot be empty/ }
      );
    });
    ...
    test('should throw error for non-existent group', async () => {
      await assert.rejects(
        async () => await addScientificName(99999, 'Test'),
        { message: /not found/ }
      );
    });
    ...
    test('should throw error for duplicate scientific name in same group', async () => {
      await assert.rejects(
        async () => await addScientificName(testGroupId, 'Testicus splitus'),
        { message: /already exists/ }
      );
    });
  ...
  describe('updateCommonName', () => {
    ...
    test('should throw error for empty name', async () => {
      await assert.rejects(
        async () => await updateCommonName(testCommonNameId, ''),
        { message: /cannot be empty/ }
      );
    });
  ...
  describe('updateScientificName', () => {
    ...
    test('should throw error for empty name', async () => {
      await assert.rejects(
        async () => await updateScientificName(testScientificNameId, ''),
        { message: /cannot be empty/ }
      );
    });
