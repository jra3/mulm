...
void describe("Date Format Utilities", () => {
  void describe("isValidDate", () => {
    void test("should return true for valid date strings", () => {
    ...
    void test("should return false for null and undefined", () => {
      assert.strictEqual(isValidDate(null), false);
      assert.strictEqual(isValidDate(undefined), false);
    });
  });

  void describe("formatShortDate", () => {
    void test("should format dates as MM/DD/YYYY", () => {
  ...
  void describe("formatLongDate", () => {
    void test('should format dates as "Month DD, YYYY"', () => {
    ...
    void test("should handle all months correctly", () => {
  ...
  void describe("formatRelativeDate", () => {
    void test('should return "just now" for very recent dates', () => {
      const now = new Date();
    ...
    void test("should format minutes ago", () => {
      const now = new Date();
  ...
  void describe("formatISODate", () => {
    void test("should format dates as ISO 8601 strings", () => {
