 ...
 */
export function getRequiredWaitingDays(
  submission: Pick<Submission, "species_type" | "species_class">
): number {
...
export function getWaitingPeriodStatusBulk<T extends Submission>(
  submissions: T[]
): Array<T & { waitingStatus: ReturnType<typeof getWaitingPeriodStatus> }> {
